...
import cn.chenzecheng.smartrmmonolith.trade.domain.OrderState;
...
import cn.chenzecheng.smartrmmonolith.trade.infrastructure.dataobject.StockedCommodityDo;
import cn.chenzecheng.smartrmmonolith.trade.infrastructure.mapper.OrderMapper;
...
//    @Pointcut("execution(* cn.chenzecheng.smartrmmonolith.trade.domain.Order.cancel(..)) "
//        + "|| execution(* cn.chenzecheng.smartrmmonolith.trade.domain.Order.succeed(..)) "
//        + "|| execution(* cn.chenzecheng.smartrmmonolith.trade.domain.Order.setPaymentId(..))")
